            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        ...
                        @if(auth()->user()->isAtasanLangsung() && $p->status === 'diajukan')
                ...
                @empty
                <tr><td colspan="11" class="text-center text-muted py-4"><i class="bi bi-inbox me-1"></i>Belum ada pengajuan.</td></tr>
                @endforelse
            </tbody>
        </table>
        </div>
