    ...
    <div class="card-body p-4">
        <form method="POST" action="{{ route('cuti.kasubag.store', $cuti) }}">
            ...
            <div class="row g-3">
                ...
                @else
                    <div class="col-12">
                        <div class="form-check form-check-lg">
                            ...
                            <label class="form-check-label fw-semibold text-success" for="kasubagSetuju">
                ...
                <input type="hidden" name="nama_kasubag" value="{{ auth()->user()->nama }}">
                <input type="hidden" name="nip_kasubag" value="{{ auth()->user()->nip }}">
            </div>
