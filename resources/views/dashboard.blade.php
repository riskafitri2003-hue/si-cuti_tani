...
{{-- SALDO CUTI (semua akun) --}}
@php
    $s = $saldoCutis->first();
    $totalSisa = ($s->saldo_n2 ?? 0) + ($s->saldo_n1 ?? 0) + ($s->saldo_n ?? 0);
@endphp
    ...
    <div class="col-md-2">
        <div class="card stat-card border-0 text-center h-100" style="border-left-color:#0d6efd;">
            <div class="card-body d-flex flex-column justify-content-center py-2">
                ...
                <div class="fs-4 fw-bold" style="color:#1a237e;">{{ $s->saldo_n2 ?? 0 }}</div>
    ...
    <div class="col-md-2">
        <div class="card stat-card border-0 text-center h-100" style="border-left-color:#0d6efd;">
            <div class="card-body d-flex flex-column justify-content-center py-2">
                ...
                <div class="fs-4 fw-bold" style="color:#1a237e;">{{ $s->saldo_n1 ?? 0 }}</div>
                <div class="small text-muted">hari</div>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card stat-card border-0 text-center h-100" style="border-left-color:#0d6efd;">
            <div class="card-body d-flex flex-column justify-content-center py-2">
                ...
                <div class="fs-4 fw-bold" style="color:#1a237e;">{{ $s->saldo_n ?? 0 }}</div>
                <div class="small text-muted">hari</div>
            </div>
        </div>
    </div>
